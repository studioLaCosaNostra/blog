...
* *Newsletter* - Podstawowe statystyki czyli ilość subskrybentów, ilość wysłanych emaili od początku istnienia. Kod HTML dla stworzonego custom elementu (Formularza subsckrybcji), którego można natychmiast wstawić na swoją stronę www czy Lead Magnet Landing Page-y. Ten widok jest także wejściem w pozostałe podstrony każdego newslettera.
