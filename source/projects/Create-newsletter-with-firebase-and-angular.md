...
Na razie nasz newsletter potrafi tylko podstawowe minimum, czyli wysłanie do wszystkich subskrybentów identycznej wiadomości. W niedalekim czasie będzie dodana automatyzacja wysyłki, co ułatwi tworzenie spersonalizowanych wiadomości na podstawie zachowań subskrybenta. Mało być więcej kodu w artykule, ale raczej to wymagałoby zrobienie z niego kilkuczęściowego kursu. Jeśli po przeczytaniu tekstu jesteś zainteresowany obejrzeniem całego kodu projektu, to zapraszam na [githuba](https://github.com/studioLaCosaNostra/email-newsletter) gdzie znajduje się cały projekt, a jeśli chcesz skorzystać z e-mail marketingu w swoim biznesie. To zacznij przygodę już dzisiaj, rejestrując się na [https://email-newsletter.web.app/](http://email-newsletter.web.app/).
